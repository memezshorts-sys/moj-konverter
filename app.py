...
st.markdown("""
    ...
    /* Prozirni Upload pravokutnik (Inicijalni okvir) */
    ...
    [data-testid="stFileUploaderFileData"] {
        background-color: rgba(255, 255, 255, 0.05) !important; /* Skoro prozirno umjesto bijelo */
...
if uploaded_file:
    ...
    if rezultat:
        st.success(f"Analiza završena: {uploaded_file.name}")
        st.table(rezultat)
